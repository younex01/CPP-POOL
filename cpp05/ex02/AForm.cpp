...
/*   Updated: 2023/02/25 19:26:58 by yelousse         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
{
    o << "AForm name:" << obj.getName() << std::endl << "AForm sign: " << obj.getSigned() <<std::endl << "AForm signGrade: " << obj.getSignGrade() << std::endl << "AForm executeGrade:" << obj.getexecuteGrade() << std::endl;
    return (o);
}